...
Default values for input arguments are given in the code. The [training data](https://github.com/puar-playground/LRA-diffusion/tree/main/model) is selected by the pre-trained CC method. An example command is given:
```
