...
Default values for input arguments are given in the code. The [training data](https://github.com/puar-playground/LRA-diffusion/tree/main/Clothing1M/annotations) is selected by the pre-trained CC model. An example command is given:
```
